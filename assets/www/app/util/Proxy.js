Ext.define('Oreilly.util.Proxy', {
	...
	process: function(url, callback) {
		...
		var sessionStore = Ext.getStore('Sessions'),
		    ...
		    sessionGroupStore = Ext.getStore('SessionGroup'),
		    speakerSessionStore = Ext.getStore('SpeakerSessions'),
		    sessionIds, proposalModel,groupModel, speakerModel, speakerSessions = {}, sessionId, speaker, sessionDays = {};
		...
		Ext.data.JsonP.request({
		    ...
		    success: function(data) {
		    	...
		    	groupModel=Ext.create('Oreilly.model.Group',data.group);
		    	groupStore.add(groupModel);
		    	sessionGroupStore.add(groupModel);
